/* ============================================================
   ...
   Здесь живёт база (темы 1–19, A1/A2). Всё, что выше уровнем, —
   в lessons-b1.js: там другой вопрос, не «какое время поставить»,
   а «какую конструкцию выбрать», и держать их в одном файле,
   который уже перевалил за 500 строк, незачем.
   ============================================================ */
import { B1_LESSONS } from './lessons-b1.js';

export const GROUPS = ['База', 'Present', 'Past', 'Future', 'Структура', 'Слова',
                       'B1 · Конструкции', 'B1 · Лексика'];
...
export const LESSONS = [...BASE_LESSONS, ...B1_LESSONS];
